...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(AppContext.getInstance().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(AppContext.getInstance().getPackageManager()) == null ||
                AppContext.getInstance().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(AppContext.getInstance().getPackageName());
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = AppContext.getInstance().getActivityList();
