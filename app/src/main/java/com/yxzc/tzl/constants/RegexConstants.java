...
public final class RegexConstants {
    ...
    /**
     * Regex of id card number which length is 15 or 18.
     */
    public static final String REGEX_ID_CARD15OR18 = "^(^[1-9]\\d{7}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}$)|(^[1-9]\\d{5}[1-9]\\d{3}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])((\\d{4})|\\d{3}[Xx])$)$";
    /**
     * Regex of email.
     */
