...
import com.yxzc.tzl.widgets.banner.listener.OnBannerListener;
import com.yxzc.tzl.widgets.banner.loader.ImageLoaderInterface;
import com.yxzc.tzl.widgets.banner.view.BannerViewPager;
...
/**
 * @Author: HouShengLi
 * @Time: 2018/10/23 11:33
 * @E-mail: 13967189624@163.com
 * @Description:轮播图、可以实现3页效果 https://github.com/youth5201314/banner
 * 更改源码，解决下一页空白问题
 */
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.drawable.banner_default_img);
        typedArray.recycle();
    }
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        if (imagesUrl.size() == 1) {
            if (imageLoader != null) {
                imageLoader.displayImage(context, imagesUrl.get(0), bannerDefaultImage);
                bannerDefaultImage.setVisibility(VISIBLE);
                Log.e(tag, "The image data set is empty.");
            } else
